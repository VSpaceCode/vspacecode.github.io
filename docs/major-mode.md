...
The major mode is using which-key's conditional bindings. If you want to modify the any of the default bindings, check out the conditional bindings [docs](./extra#conditional-bindings-experimental).
